...
sp.on("data", function(data) {
	...
	if(it == 0){angle_2 = data_object.outputA;value_2 = data_object.outputD;}
	if(it == 1){angle_1 = data_object.outputA;value_1 = data_object.outputD;}
	if(it == 2){angle_0 = data_object.outputA;value_0 = data_object.outputD;}
	if (it>2) {
		angle_2 = angle_1;
		angle_1 = angle_0;
		angle_0 = data_object.outputA;
		value_2 = value_1;
		value_1 = value_0;
		value_0 = data_object.outputD;
	...
	//console.log(angle_1);
	//console.log(angle_2);
if(data_object.outputA == 0)
{
if (angle_1 > angle_2) { data_object.outputA = angle_1 + angle_1 - angle_2; }
if (angle_1 < angle_2) { data_object.outputA = angle_1 - (angle_2 - angle_1); }
data_object.outputD = value_1;




}
console.log(data_object.outputA);
	var data_json_def = JSON.stringify(data_object);
	//console.log(data_json_def);
